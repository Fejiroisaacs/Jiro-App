    ...
    <guide-page heading="Culinara guide" mark="culinara"
      ...
      <guide-section id="find-a-recipe" title="Find a recipe"
        ...
        <guide-steps>
          ...
          <li>If you have collections, the row below the tags filters by collection in the same way.</li>
      ...
      <guide-section id="use-collections" title="Group recipes into collections"
        ...
        <guide-steps>
          <li>To make your first collection, select <strong>New recipe</strong>, open <strong>Add to Collection</strong>, choose <strong>+ New Collection</strong>, type a name and select <strong>Create</strong>.</li>
          <li>Once you have one, you can also make more from the <a routerLink="/culinara">Culinara</a> page: select <strong>+</strong> at the end of the collection row, type a name and press <kbd>Enter</kbd>.</li>
      ...
      <guide-section id="plan-the-week" title="Plan the week's meals"
        ...
        <guide-steps>
          ...
          <li>Select an empty part of the box for the day and meal you want.</li>
          <li>Search for a recipe if you need to, then select it. It appears in that box.</li>
          <li>To take a recipe off, select the <strong>×</strong> on it.</li>
        ...
        <guide-shot guide="culinara" name="planner-picker" [width]="960" [height]="492"
          alt="The window for adding to Friday's breakfast, searched for oat, listing Banana Oat Pancakes and Overnight Oats with Berries." />
        <guide-tip>A box can hold more than one recipe. On a phone, scroll the calendar sideways to see the other days.</guide-tip>
      </guide-section>

      <guide-section id="grocery-list" title="Make a grocery list"
        lead="Turn recipes into a shopping list and tick items off in the shop.">
        <guide-steps>
        ...
        <guide-shot guide="culinara" name="grocery-list" [width]="1600" [height]="1163"
          alt="The grocery list with 12 items remaining, grouped under Overnight Oats with Berries and Greek Chicken Rice Bowls, with rolled oats and milk ticked and crossed out." />
        <guide-tip>The grocery list is kept in this browser on this device, not in your account, so it does not appear on your other devices. Adding the same recipe twice adds its ingredients twice.</guide-tip>
      </guide-section>
